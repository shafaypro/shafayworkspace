...
def tabulate(tabular_data, headers=[], tablefmt="simple",
    ...
    numbers.txt (or flushes integer numbers.txt to the right), and flushes
    ...
    Pandoc grid_tables:
    >>> print(tabulate([["spam", 41.9999], ["eggs", "451.0"]],
    ...                ["strings", nnumbers.txttxt], "grid"))
    +-----------+-----------+
    | strings   | numbers.txtrs |
    +===========+===========+
    | spam      |   41.9999 |
    +-----------+-----------+
    | eggs      |  451      |
    ...
    >>> print(tabulate([["strings",numbers.txtrs"], ["spam", 41.9999], ["eggs", "451.0"]],
    ...                headers="firstrow", tablefmt="mediawiki"))
    {| class="wikitable" style="text-align: left;"
    |+ <!-- caption -->
    |-
    ! strings   !! align="right"| numbers.txtrs
    |-
